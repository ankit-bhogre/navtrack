...
import { setContactsUnstarred, setContactsStarred, removeContacts } from './store/contatosSlice';

function ContatosMultiSelectMenu(props) {
...
export default ContatosMultiSelectMenu;
