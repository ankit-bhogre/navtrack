...
import { seIntaladoresSearchText } from './store/instaladoresSlice';

function InstaladoresHeader(props) {
					...
					<FuseAnimate animation="transition.slideLeftIn" delay={300}>
						...
						>
							...
							<Input
								...
								onChange={ev => dispatch(seIntaladoresSearchText(ev))}
							/>
						</Paper>
					</FuseAnimate>
				</ThemeProvider>
...
export default InstaladoresHeader;
